...
const initializeDatabase = async () => {
    try {
        ...
        `)
        if (true || !resUsers.rows[0].exists) {
        ...
        if (!resTasks.rows[0].exists) {
            ...
            const tasks = [
                ...
                {
                    title: 'Finish report',
                    description: 'Work report for Q1',
                    status: 'in_progress',
                    user_id: 1,
                },
                {
                    title: 'Call mom',
                    description: 'Check in this weekend',
                    status: 'completed',
                    user_id: 1,
                },
                {
                ...
                },
                {
                    ...
                    description: 'Team sync next week',
                    status: 'in_progress',
                    user_id: 1,
                },
                {
                    title: 'Approve budget',
                    description: 'Q2 expenses',
                    status: 'completed',
                    user_id: 1,
                },
                {
                    title: 'Update policies',
                    description: 'New security rules',
                    status: 'pending',
                    user_id: 1,
                },
                {
